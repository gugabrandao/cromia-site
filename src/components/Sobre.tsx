...
const produtos = [
  ...
  {
    titulo: 'Cromia Stock',
    texto: 'Especialmente desenhado para lojas de ferragens e ferramentas. Automatizamos o atendimento com acesso direto ao estoque em tempo real, acelerando o ciclo de venda e precisão do inventário.',
  },
  {
